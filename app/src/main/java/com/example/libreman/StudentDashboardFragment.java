...
public class StudentDashboardFragment extends Fragment {
    ...
    private TextView tvGreeting, tvBorrowedCount, tvOverdueCount, tvFineAmount;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        tvFineAmount = view.findViewById(R.id.tvFineAmount);
        ...
        rvCurrentReads.setLayoutManager(new LinearLayoutManager(getContext()));
                ...
                new BorrowRecordHelper.RecordListCallback() {
                    ...
                    public void onRecordsLoaded(List<BorrowRecord> records) {
                        ...
                        getActivity().runOnUiThread(() -> {
                            ...
                            tvFineAmount.setText("Rs." + (int) totalFine);
